...
func (c *exampleClient) ExampleTest(ctx context.Context, in *ExampleRequest, opts ...grpc.CallOption) (*ExampleReply, error) {
	out := new(ExampleReply)
	err := c.cc.Invoke(ctx, "/api.swaggerfileserver.Example/ExampleTest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedExampleServer) ExampleTest(context.Context, *ExampleRequest) (*ExampleReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExampleTest not implemented")
}
...
func _Example_ExampleTest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExampleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExampleServer).ExampleTest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.swaggerfileserver.Example/ExampleTest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServer).ExampleTest(ctx, req.(*ExampleRequest))
	}
